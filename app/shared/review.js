(function attachReview(root, factory) {
  ...
  function buildReviewRecord(inputs) {
    ...
    return {
      ...
      reviewerRole: text(inputs.reviewerRole) || "Not recorded",
      blockers,
      evidence: evidenceRows(inputs),
      meetingEvidence: [
        ["Most useful summary line", text(inputs.mostUsefulLine) || "Not recorded"],
        ["Noisiest or riskiest line", text(inputs.noisiestLine) || "Not recorded"],
        ["Missing information that matters", text(inputs.missingInformation) || "Not recorded"],
        ["Unsafe or misleading wording", text(inputs.unsafeWording) || "None recorded"],
        ["Expected workflow slot", text(inputs.expectedWorkflowSlot) || "Not recorded"],
        ["Staff burden concern", text(inputs.staffBurdenConcern) || "Not recorded"],
        ["Case-specific evidence", text(inputs.caseEvidence) || "Not recorded"]
      ],
