...
const AMBIGUITY_PATTERNS = [
  {
    ...
    label: "疼痛位置不清楚",
    patterns: ["下面痛", "下面會痛", "下面不舒服", "那邊痛", "那邊會痛", "私密處", "下體痛", "會陰不舒服", "尿道痛", "生殖器痛"],
    clearPatterns: ["尿尿時", "排尿時", "下腹", "陰囊", "睪丸", "會陰", "尿道刺痛", "尿道灼熱"],
  ...
  },
  {
    ...
    label: "泌尿主訴類型不清楚",
    patterns: ["尿尿怪怪", "尿尿怪", "小便怪怪", "解尿怪怪", "尿尿不舒服", "說不出來", "怪怪的"],
    clearPatterns: ["夜尿", "頻尿", "尿不出來", "尿流", "漏尿", "血尿", "尿痛", "刺痛", "灼熱", "血塊"],
