...
- 本文件：說明 clinical need、workflow、安全邊界與醫師討論問題。
- Live demo 入口：`http://localhost:4173/app/review-packet/`
- 病人/家屬端：`http://localhost:4173/app/patient-demo/`
- 護理補問工作台：`http://localhost:4173/app/nurse-workbench/`
...
![MVP review packet entrypoint](product/screenshots/08-review-packet-entry.png)
