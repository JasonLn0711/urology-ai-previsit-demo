...
- `v1-current-system-benchmark-table.md`: match / omit / defer / governance-review table for `聯醫小幫手` and `陽明小幫手`.
...
This verifies the v1 route, five synthetic cases, live capture sheet, current-system benchmark table, scorecard, priority-flow worksheet, safety boundaries, smoke checks, and tests before reviewer time is used.
...
5. Fill `v1-current-system-benchmark-table.md`.
6. Confirm or revise `v1-priority-flow-shortlist.md`.
7. Fill `v1-review-scorecard.md` and `v1-priority-flow-review-worksheet.md`.
8. Summarize with `v1-phase0-analysis-template.md`.
9. Decide with `v1-phase0-decision-memo-template.md`.
10. Update `v1-governance-gate-register.md`.
